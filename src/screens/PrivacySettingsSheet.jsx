    ...
    rows: [
      {
        ...
        icon: 'globe',
        label: 'Profil public',
        detail: 'Visible par tous · sinon limité à tes amis',
      },
      {
        key: 'discoverable',
        icon: 'search',
        label: 'Apparaître dans les recherches',
        detail: 'Les autres peuvent te trouver pour t\'ajouter',
      },
      {
        key: 'showStats',
        icon: 'check',
        label: 'Afficher mes statistiques',
        detail: 'Sorties, groupes et amis sur ton profil',
      },
    ],
  },
  {
    ...
    rows: [
      {
        key: 'messagesFromAll',
        icon: 'bell',
        label: 'Messages de tous',
        detail: 'Sinon, seuls tes amis peuvent t\'écrire',
      },
      {
        key: 'invitesFromAll',
        icon: 'users',
        label: 'Invitations de tous',
        detail: 'Sinon, seuls tes amis peuvent t\'inviter aux sorties',
      },
      {
        key: 'shareJoinedSorties',
        icon: 'pin',
        label: 'Partager les sorties rejointes',
        detail: 'Tes amis voient les sorties auxquelles tu participes',
      },
    ],
  },
]
      ...
      >
        <div style={{ padding: '14px 20px 30px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
            <div>
              ...
              <div style={{ fontSize: 12, color: 'var(--ink-mute)', marginTop: 5 }}>
                Choisis qui peut te voir et te contacter.
              </div>
            </div>
                ...
                {group.rows.map((row, i) => {
                  ...
                  return (
                    <div key={row.key} style={{
                      ...
                      <Toggle
                        checked={active}
                        onChange={value => updatePrivacySetting(row.key, value)}
                      />
                    </div>
                  )
                })}
          ...
          <div style={{
            ...
            padding: 14,
            borderRadius: 14,
            background: 'rgba(198,93,61,0.06)',
            border: '1px solid rgba(198,93,61,0.18)',
            display: 'flex',
            gap: 10,
          }}>
            <div style={{
            ...
            <div style={{ fontSize: 12, color: 'var(--ink-soft)', lineHeight: 1.45 }}>
              Tes choix sont enregistrés sur cet appareil. La synchronisation avec ton compte sera disponible bientôt.
            </div>
          </div>
        </div>
      </div>
